        ...
        @forelse($areas as $index => $area)
            <div class="col-lg-6 col-xl-4 mb-4">
                <div class="card h-100 area-card position-relative">
                    <a href="{{ route('master-data.area.show', ['area' => $area]) }}" class="text-reset text-decoration-none d-block">
                    ...
                    <div class="card-footer bg-transparent border-0 pt-0 position-relative">
                        <div class="d-flex gap-2">
                            <a href="{{ route('master-data.area.show', ['area' => $area]) }}" 
                               class="btn btn-outline-info btn-sm flex-fill">
                                <i class="fas fa-eye me-1"></i>View Details
                            </a>
                            <a href="{{ route('master-data.area.edit', ['area' => $area]) }}" 
                               class="btn btn-outline-warning btn-sm flex-fill">
                                <i class="fas fa-edit me-1"></i>Edit
                            </a>
                            <button class="btn btn-outline-danger btn-sm flex-fill delete-btn" 
                                    data-id="{{ $area->getRouteKey() }}" 
                                    data-name="{{ $area->name }}">
