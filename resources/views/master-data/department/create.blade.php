...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create Supervisor</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold font-dark">Form Create Supervisor</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('master-data.department.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('supervisor') is-invalid @enderror" 
                                   id="supervisor" name="supervisor" value="{{ old('supervisor') }}" required>
                            @error('supervisor')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('workgroup') is-invalid @enderror" 
                                   id="workgroup" name="workgroup" value="{{ old('workgroup') }}">
                            @error('workgroup')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('master-data.department.index') }}" class="btn btn-secondary me-2">Cancel</a>
