                ...
                <div class="dropdown-menu dropdown-menu-end p-3" aria-labelledby="historyCreatedBtn" style="min-width: 420px;" onclick="event.stopPropagation();">
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" id="history_created_start" class="form-control form-control-sm elegant-datepicker" placeholder="Select date" readonly />
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label small fw-bold" for="history_created_end">End</label>
                            <input type="text" id="history_created_end" class="form-control form-control-sm elegant-datepicker" placeholder="Select date" readonly disabled />
                        </div>
                    </div>
