...
<div class="container-fluid px-4">
    ...
    <div class="card p-4">
        <form action="{{ route('laporan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="supervisor" class="form-label">Person in Charge:</label>
                <input type="text" class="form-control" id="supervisor" readonly>
            </div>

            <div class="mb-3">
                <label for="kategori_masalah" class="form-label">Problem Category:</label>
                <select class="form-select @error('kategori_masalah') is-invalid @enderror" id="kategori_masalah" name="kategori_masalah" required>
                    ...
                    <option value="Safety: Potential Hazards" {{ old('kategori_masalah') == 'Safety: Potensi Bahaya' ? 'selected' : '' }}>Safety: Potential Hazards</option>
                    <option value="5S: Streamlined, Organized, Clean, Maintained, and Diligent" {{ old('kategori_masalah') == '5S: Ringkas, Rapi, Resik, Rawat, dan Rajin' ? 'selected' : '' }}>5S: Streamlined, Organized, Clean, Maintained, and Diligent</option>
                </select>
