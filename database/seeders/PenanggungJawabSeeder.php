...
class PenanggungJawabSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $penanggungJawabData = [
            ...
            ['id' => 6, 'area_id' => 1, 'station' => 'Packing', 'name' => 'Bayu Putra Trianto', 'email' => 'bayu.trianto@siemens.com'],
            ...
            ['id' => 9, 'area_id' => 1, 'station' => 'General', 'name' => 'Asept Surachaman', 'email' => 'asept.surachaman@siemens.com'],

            // Area 2 (Quality Control)
            ['id' => 10, 'area_id' => 2, 'station' => 'QC LV', 'name' => 'Ishak Marthen', 'email' => 'ishak.marthen@siemens.com'],
            ['id' => 11, 'area_id' => 2, 'station' => 'QC MV', 'name' => 'Sirad Nova Mihardi', 'email' => 'sirad.mihardi@siemens.com'],
            ['id' => 12, 'area_id' => 2, 'station' => 'IQC', 'name' => 'Abduh Al Agani', 'email' => 'abduh.agani@siemens.com'],
            ['id' => 13, 'area_id' => 2, 'station' => 'General', 'name' => 'Arif Hadi Rizali', 'email' => 'arif.rizali@siemens.com'],

            // Area 3 (Warehouse)
            ['id' => 14, 'area_id' => 3, 'station' => 'General', 'name' => 'Suhendra', 'email' => 'suhendra@siemens.com'],
            ['id' => 15, 'area_id' => 3, 'station' => 'Warehouse', 'name' => 'Wahyu Wahyudin', 'email' => 'wahyu.wahyudin@siemens.com'],
        ];
